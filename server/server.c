...
static void moveByKey(char key, int* dx, int* dy, bool *keepMoving) {
  ...
  *keepMoving = false;
  ...
  switch (key) {
    ...
    case 'h': *dx = 0; *dy = -1; return;  //move left, if possible
    case 'l': *dx = 0; *dy = 1;  return;  // move right, if possible
    case 'j': *dx = 1; *dy = 0;  return;  //move down, if possible
    case 'k': *dx = -1; *dy=0;   return;  //move up, if possible
    ...
    case 'H': *dx = 0; *dy = -1; *keepMoving = true; return;  //move left, if possible
    case 'L': *dx = 0; *dy = 1;  *keepMoving = true; return;  // move right, if possible
    case 'J': *dx = 1; *dy = 0;  *keepMoving = true; return;  //move down, if possible
